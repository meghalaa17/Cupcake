...
import com.example.cupcake.ui.OrderViewModelFactory
...
enum class CupcakeScreen(@StringRes val title: Int) {
    ...
    History(title = R.string.order_history)   // NEW screen
}
...
fun CupcakeApp(
    ...
    // Create the ViewModel using our factory so the repository is injected
    val viewModel: OrderViewModel = viewModel(
        factory = OrderViewModelFactory(
            (context.applicationContext as CupcakeApplication).repository
        )
    )
    ...
    Scaffold(
        ...
        val savedOrders by viewModel.savedOrders.collectAsState()  // NEW
        ...
        NavHost(
            ...
            // NEW: order history screen powered by Room
